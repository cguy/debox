		...
		*/
		...
		nextSlide: function() {
			return this.each(function() {
				...
				$(this).rsfSlideshow('showSlide', data.slides[data.this_slide], 'slideLeft');
			});
		},
		...
		*/
		...
		previousSlide: function() {
			return this.each(function() {
				...
				$(this).rsfSlideshow('showSlide', data.slides[data.this_slide], 'slideRight');
			});
		},
					...
					if (height) {
						topOffset = Math.ceil((containerHeight / 2) - (height / 2));
                                                if (height > (containerHeight*0.9)) {
                                                    topOffset = containerHeight*0.025;
                                                    var reducW =  (containerHeight*0.9*width)/height;
                                                    leftOffset = (containerWidth - reducW) / 2;
                                                }
					}
